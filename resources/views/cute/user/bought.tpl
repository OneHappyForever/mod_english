				...
				<section class="content-inner margin-top-no">
					...
					<div class="table-responsive">
						...
						<table class="table ">
                            ...
                            <tr>
								<td>
                                    <a class="btn btn-brand" {if $shop->renew==0}disabled{else} href="javascript:void(0);" onClick="delete_modal_show('{$shop->id}')"{/if}>Cancel automatic renewal</a>
                                </td>
                                <td>#{$shop->id}</td>
						...
						<div class="modal-dialog modal-xs">
							<div class="modal-content">
								<div class="modal-heading">
									...
									<h2 class="modal-title">Do you want to cancel this subscription's automatic renewal?</h2>
								</div>
